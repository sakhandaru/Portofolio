...
export function About() {
  return (
    ...
    <div className="bg-gray-100 dark:bg-black">
      <TextReveal title="About me 👋">Hi, I’m Rifqis Sakha Hilmi Aziz — a passionate Frontend Developer currently exploring the world of backend development to become a well-rounded Fullstack Engineer. I love crafting clean, interactive, and efficient user interfaces with Next.js, Tailwind CSS, and modern animation tools like GSAP and Framer Motion.
